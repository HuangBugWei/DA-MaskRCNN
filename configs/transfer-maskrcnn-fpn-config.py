...
train["init_checkpoint"] = "./0626-gemini/ablation-DA-25k/model_final.pth"
train["output_dir"] = f"./ablation-transfer-{model.backbone.bottom_up.freeze_at}"
...
# DatasetCatalog.register('steel_test_source', lambda :  get_rebar_dicts("/home/aicenter/maskrcnn/rebar-revit-auto-dataset/target-slab.txt", txt=True))
