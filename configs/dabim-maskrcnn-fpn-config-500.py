...
train["output_dir"] = "./ablation-DA-25k-500"
model.do_domain = True

DatasetCatalog.register('steel_train', lambda : get_rebar_dicts("/home/aicenter/maskrcnn/rebar-revit-auto-dataset/valid-500-5-types.txt", txt=True))
