...
train["output_dir"] = "./ablation-no-DA-500"
model.do_domain = False

DatasetCatalog.register('steel_train', lambda :  get_rebar_dicts("/home/aicenter/maskrcnn/rebar-revit-auto-dataset/valid-500-20types.txt", txt=True))
