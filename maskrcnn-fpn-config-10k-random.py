...
train["output_dir"] = "./ablation-no-DA-10k-random"
model.do_domain = False

DatasetCatalog.register('steel_train', lambda :  get_rebar_dicts("/home/aicenter/maskrcnn/rebar-revit-auto-dataset/valid-10k-random.txt", txt=True))
