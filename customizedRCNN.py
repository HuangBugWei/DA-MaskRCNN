...
class customRCNN(GeneralizedRCNN):
    def __init__(self,
        ...
        if self.do_domain:
            self.discriminatorRes2 = DiscriminatorRes2()
    ...
    def forward(self, 
        ...
        if self.do_domain:
            ...
            loss_res2 = self.discriminatorRes2(res["res2"], domain_label, alpha2)
        ...
        if self.do_domain:
            losses.update({"loss_r2": loss_res2, "loss_r3": loss_res3, "loss_r4": loss_res4, "loss_r5": loss_res5})
