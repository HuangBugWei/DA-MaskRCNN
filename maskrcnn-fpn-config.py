...
train["output_dir"] = "./ablation-no-DA-25k"
model.do_domain = False

DatasetCatalog.register('steel_train', lambda :  get_rebar_dicts("/home/aicenter/maskrcnn/rebar-revit-auto-dataset/files-24826.txt", txt=True))
